namespace Loupedeck.ResearchAidPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.ResearchAidPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.ResearchAidPlugin.Resources.Resource.txt`.
