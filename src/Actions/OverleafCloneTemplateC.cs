namespace Loupedeck.ResearchAidPlugin
{
    ...
    // Command to clone Overleaf Template C
    public class OverleafCloneTemplateC : PluginDynamicCommand
    {
        private String _lastStatus = "";

        public OverleafCloneTemplateC()
            : base(displayName: "Template C", description: "Clone Template C project", groupName: "Clone Overleaf")
        {
        }

        protected override void RunCommand(String actionParameter) => _ = this.ExecuteCloneAsync("TemplateC");
        ...
        protected override String GetCommandDisplayName(String actionParameter, PluginImageSize imageSize)
        {
            return String.IsNullOrEmpty(this._lastStatus) 
                ? "Template C" 
                : $"Template C{Environment.NewLine}{this._lastStatus}";
        }
    }
}
